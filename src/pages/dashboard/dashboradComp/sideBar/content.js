            ...
            {() => (
              <>
                <MenuButton
                  ...
                  as={Button}
                  rightIcon={
                    firstMenuDisclosure.isOpen ? <MinusIcon /> : <AddIcon />
                  }
                  onClick={firstMenuDisclosure.onToggle}
                  style={{
                    backgroundColor: firstMenuDisclosure.isOpen
                      ? "#89644E"
                      : "initial",
                  }}
                >
            ...
            {() => (
              <>
                <MenuButton
                  ...
                  as={Button}
                  rightIcon={
                    secondMenuDisclosure.isOpen ? <MinusIcon /> : <AddIcon />
                  }
                  onClick={secondMenuDisclosure.onToggle}
                  style={{
                    backgroundColor: secondMenuDisclosure.isOpen
                      ? "#89644E"
                      : "initial",
                  }}
                >
            ...
            {() => (
              <>
                <MenuButton
                  ...
                  as={Button}
                  rightIcon={
                    tharidMenuDisclosure.isOpen ? <MinusIcon /> : <AddIcon />
                  }
                  onClick={tharidMenuDisclosure.onToggle}
                  style={{
                    backgroundColor: tharidMenuDisclosure.isOpen
                      ? "#89644E"
                      : "initial",
                  }}
                >
