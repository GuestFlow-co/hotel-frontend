...
function LoginProvider(props) {
    ...
    try {
      ...
      if (auth) { 
        try { 
          ...
          // cookie.save("fulluser", fulluser);
          // setFulluser(auth.user)
  ...
  function validateToken(token){
    try{
      ...
      console.log("validdddd",validUser);
  ...
  return(
    <LoginContext.Provider value={{errorMessage, able, login, logout, loginData, dispatch,fulluser,setFulluser }}>
      {props.children }
